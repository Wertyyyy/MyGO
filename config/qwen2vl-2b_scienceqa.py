...
dataset = {
    "train_impl_path": "implement.dataset.science_qa",
    "train_dataset_path": get_path("data", "ScienceQA"),
    "test_impl_path": "implement.dataset.science_qa",
    "test_dataset_path": get_path("data", "ScienceQA"),
